...
#ifndef SENSE_VL6180X_H_
#define SENSE_VL6180X_H_
...
public:
	...
	VL6180x(uint8_t address, HAL_I2C* i2c, Semaphore* sem);
...
private:
	...
	void setTransmitBuffer(uint16_t val);
